...
public class EmailSenderManager {
     ...
     */
    @Inject
    private EditorViewManager editorView;
    ...
    public void setEditorView(EditorViewManager editorView) {
    ...
    public String sendEmail() throws AddressException, MessagingException {
        ...
        try {
            ...
            htmlEmailMessage.addRecipient(Message.RecipientType.TO, new InternetAddress(editorView.getSellerEmail()));
            ...
            htmlEmailMessage.setSubject("Contact request from SellStuff");
