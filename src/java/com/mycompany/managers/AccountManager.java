...
public class AccountManager implements Serializable {
    ...
    public void setListingFacade(ListingFacade facade) {
        this.listingFacade = facade;
    }
    
    public ListingPhotoFacade getListingPhotoFacade() {
        return this.listingPhotoFacade;
    }
    
    public void setListingPhotoFacade(ListingPhotoFacade facade) {
        this.listingPhotoFacade = facade;
    }
